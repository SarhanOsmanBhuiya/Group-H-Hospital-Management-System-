...
<body>
	...
	<div class="wrap container">
		...
		<div class="contact">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 k">
					<h2>Contact Number : <span>316723,2334678</span></h2>
					<h2>Email : <span>farazy@gmail.com</span></h2>
					<h2>Facebook : <span>Farazy Hospital Limited</span></h2>
					<h2><span>We Care, Allah Cure</span></h2>
				</div>
			</div>
		</div>
